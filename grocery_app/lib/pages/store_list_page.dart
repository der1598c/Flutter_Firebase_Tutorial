...
class _StoreListPage extends State<StoreListPage> {
  ...
  StoreListViewModel _storeListViewModel = StoreListViewModel();
  ...
  void _navigateToStoreItems(BuildContext context, StoreViewModel store) async {
    final bool reflashStores = await Navigator.push(context, MaterialPageRoute(builder: (context) => StoreItemListPage(store: store)));
  ...
  void _navigateToAddStorePage(BuildContext context) {
    Navigator.push(context, MaterialPageRoute(
      builder: (context) => ChangeNotifierProvider(create: (context) => AddStoreViewModel(),
      child: AddStorePage()
    ),
